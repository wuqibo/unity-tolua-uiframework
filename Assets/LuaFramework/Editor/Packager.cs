...
public class Packager
{
    ...
    [MenuItem("LuaFramework/Build iPhone AssetBundle", false, 100)]
    public static void BuildiPhoneResource()
    {
        BuildAssetResource(BuildTarget.iOS, 0);
    }

    [MenuItem("LuaFramework/Build Android AssetBundle/All", false, 101)]
    public static void BuildAndroidResourceAll()
    {
        BuildAssetResource(BuildTarget.Android, 0);
    }

    [MenuItem("LuaFramework/Build Android AssetBundle/Lua", false, 101)]
    public static void BuildAndroidResourceLua()
    {
        BuildAssetResource(BuildTarget.Android, 1);
    }

    [MenuItem("LuaFramework/Build Android AssetBundle/Res", false, 101)]
    public static void BuildAndroidResourceRes()
    {
        BuildAssetResource(BuildTarget.Android, 2);
    }

    [MenuItem("LuaFramework/Build Windows AssetBundle", false, 102)]
