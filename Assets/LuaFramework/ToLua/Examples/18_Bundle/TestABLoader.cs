...
public class TestABLoader : MonoBehaviour
{
    ...
    public IEnumerator LoadBundles()
    {
        ...
        List<string> list = new List<string>() {
            "lua"+LuaConst.ExtName,
            "lua_cjson"+LuaConst.ExtName,
            "lua_system"+LuaConst.ExtName,
            "lua_unityengine"+LuaConst.ExtName,
            "lua_protobuf"+LuaConst.ExtName,
            "lua_misc"+LuaConst.ExtName,
            "lua_socket"+LuaConst.ExtName,
            "lua_system_reflection"+LuaConst.ExtName
        };
#endif
