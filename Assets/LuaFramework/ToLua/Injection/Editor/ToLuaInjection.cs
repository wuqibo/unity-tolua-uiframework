...
public static class ToLuaInjection
{
    ...
    {
        var injectionStatus = EditorPrefs.GetInt(LuaConst.frameworkRoot + "WaitForInjection", 0);
    ...
    static void OnPostprocessBuild(BuildTarget target, string pathToBuiltProject)
    {
        ...
        EditorPrefs.SetInt(LuaConst.frameworkRoot + "WaitForInjection", 0);
    }
    ...
    static void OnPostProcessScene()
    {
        ...
        {
            EditorPrefs.SetInt(LuaConst.frameworkRoot + "WaitForInjection", 1);
        }
    ...
    static AssemblyDefinition LoadAndCheckAssembly(bool bPulse)
    {
        ...
        EditorPrefs.SetInt(LuaConst.frameworkRoot + "InjectStatus", alreadyInjected ? 1 : 0);
    ...
    static void Inject()
    {
        ...
        try
        {
            ...
            if (InjectPrepare(assembly))
            {
                ...
                EditorPrefs.SetInt(LuaConst.frameworkRoot + "InjectStatus", 1);
            }
        }
        catch (Exception e)
        {
    ...
    {
        bool alreadyInjected = EditorPrefs.GetInt(LuaConst.frameworkRoot + "InjectStatus") == 1;
        if (alreadyInjected)
        {
