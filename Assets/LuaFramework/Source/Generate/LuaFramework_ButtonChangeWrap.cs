...
public class LuaFramework_ButtonChangeWrap
{
	public static void Register(LuaState L)
	{
		L.BeginClass(typeof(LuaFramework.ButtonChange), typeof(UnityEngine.MonoBehaviour));
	...
	static int OnPointerDown(IntPtr L)
	{
		try
		{
			...
			LuaFramework.ButtonChange obj = (LuaFramework.ButtonChange)ToLua.CheckObject<LuaFramework.ButtonChange>(L, 1);
	...
	static int get_targetImg(IntPtr L)
	{
		...
		try
		{
			...
			LuaFramework.ButtonChange obj = (LuaFramework.ButtonChange)o;
