...
public class DelegateFactory
{
	...
	class System_Action_LuaFramework_BaseEventData_Event : LuaDelegate
	{
		public System_Action_LuaFramework_BaseEventData_Event(LuaFunction func) : base(func) { }
		public System_Action_LuaFramework_BaseEventData_Event(LuaFunction func, LuaTable self) : base(func, self) { }

		public void Call(LuaFramework.BaseEventData param0)
		{
			func.BeginPCall();
			func.PushObject(param0);
			func.PCall();
		...
		public void CallWithSelf(LuaFramework.BaseEventData param0)
		{
			func.BeginPCall();
			func.Push(self);
			func.PushObject(param0);
	...
	public System.Action<LuaFramework.BaseEventData> System_Action_LuaFramework_BaseEventData(LuaFunction func, LuaTable self, bool flag)
	{
		if (func == null)
		{
			System.Action<LuaFramework.BaseEventData> fn = delegate(LuaFramework.BaseEventData param0) { };
			return fn;
		}

		if(!flag)
		{
			System_Action_LuaFramework_BaseEventData_Event target = new System_Action_LuaFramework_BaseEventData_Event(func);
			System.Action<LuaFramework.BaseEventData> d = target.Call;
			target.method = d.Method;
			return d;
		}
		else
		{
			System_Action_LuaFramework_BaseEventData_Event target = new System_Action_LuaFramework_BaseEventData_Event(func, self);
			System.Action<LuaFramework.BaseEventData> d = target.CallWithSelf;
			target.method = d.Method;
			return d;
		}
	}

	bool Check_System_Action_LuaFramework_BaseEventData(IntPtr L, int pos)
	{
		return TypeChecker.CheckDelegateType(typeof(System.Action<LuaFramework.BaseEventData>), L, pos);
	}

	void Push_System_Action_LuaFramework_BaseEventData(IntPtr L, System.Action<LuaFramework.BaseEventData> o)
	{
		ToLua.Push(L, o);
	}
	...
	class LuaFramework_TweenEvent_Event : LuaDelegate
	{
		public LuaFramework_TweenEvent_Event(LuaFunction func) : base(func) { }
		public LuaFramework_TweenEvent_Event(LuaFunction func, LuaTable self) : base(func, self) { }
	...
	public LuaFramework.TweenEvent LuaFramework_TweenEvent(LuaFunction func, LuaTable self, bool flag)
	{
		if (func == null)
		{
			LuaFramework.TweenEvent fn = delegate(UnityEngine.Transform param0) { };
			return fn;
		}

		if(!flag)
		{
			LuaFramework_TweenEvent_Event target = new LuaFramework_TweenEvent_Event(func);
			LuaFramework.TweenEvent d = target.Call;
			target.method = d.Method;
			return d;
		}
		else
		{
			LuaFramework_TweenEvent_Event target = new LuaFramework_TweenEvent_Event(func, self);
			LuaFramework.TweenEvent d = target.CallWithSelf;
			target.method = d.Method;
			return d;
		}
	}

	bool Check_LuaFramework_TweenEvent(IntPtr L, int pos)
	{
		return TypeChecker.CheckDelegateType(typeof(LuaFramework.TweenEvent), L, pos);
	}

	void Push_LuaFramework_TweenEvent(IntPtr L, LuaFramework.TweenEvent o)
	{
		ToLua.Push(L, o);
	}
