...
namespace LuaFramework
{
    public class MoveUpdate : MonoBehaviour
    {
        ...
        public void Move(float delay, Vector3 toPos, float time, Tween.EaseType method, Action OnEndEvent, TweenEvent OnEndEventWithParam, bool worldSpace, bool xEnable, bool yEnable, bool zEnable)
        {
            for (int i = 0; i < paramsQueue.Count; i++)
            {
