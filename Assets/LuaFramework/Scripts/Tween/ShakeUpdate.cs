...
namespace LuaFramework
{
    public class ShakeUpdate : MonoBehaviour
    {
        ...
        void Update()
        {
            ...
            if (shakerTimer > 0f)
            {
                ...
                if (shakerTimer <= 0f)
                {
                    ...
                    if (scale != 1f)
                    {
                        Tween.StartScale(0, transform, defaultScale, 0.2f, Tween.EaseType.SineOut);
                    }
                }
            }
        }
        ...
        void ShakeGo(Params _params)
        {
            ...
            Tween.StartValue(0, this.offset, 0, _params.time, Tween.EaseType.Linear, (float v) =>
            {
                this.offset = v;
            });
            ...
            if (this.scale != 1f)
            {
                ...
                Tween.StartScale(0, transform, defaultScale * _params.scale, 0.1f, Tween.EaseType.SineOut);
            }
        }
    }
}