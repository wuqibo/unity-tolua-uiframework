...
public static class CustomSettings
{
    ...
    {                
        ...
        _GT(typeof(Transform)).AddExtendType(typeof(DG.Tweening.ShortcutExtensions)).AddExtendType(typeof(DG.Tweening.DOTweenExtend)).AddExtendType(typeof(BButtonExtend)),
